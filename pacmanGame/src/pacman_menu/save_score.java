...
public class save_score extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(save_score.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
