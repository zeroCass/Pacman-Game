...
public class GhostRed extends Entity {
    Image [] ghostImage;
    Image [] scaredImage;
    private int ghostImageIdx;
    private int scaredImageIdx;
    
    private int [] targetPosition; //define wich the current target
    private int [] previousPosition;
    private int target_x, target_y;
    
    private boolean eaten;
    private String currentMode; //scatter,chaser,scared, eaten
   
    //constructor
    public GhostRed (int y, int x) {
